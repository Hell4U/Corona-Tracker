...
<sql:setDataSource var="db" driver="com.mysql.cj.jdbc.Driver" url="jdbc:mysql://sql6.freemysqlhosting.net:3306/sql6405344" user="sql6405344" password="kNClFQPRil" ></sql:setDataSource>
